  ...
  return (
    <View style={warningSignStyles.container}>
      ...
      <ScrollView style={warningSignStyles.descriptionContainer}>
        ...
        <Text style={{ fontFamily: 'JakartaSemiBold' }}>Sexual abuse </Text>exists in any situation in which one partner forces another to participate in unwanted, unsafe, or degrading sexual activity. Forcible sex, even by a spouse or intimate partner, is an act of aggression and violence.
        </Text>
      </ScrollView>
    </View>
  );
