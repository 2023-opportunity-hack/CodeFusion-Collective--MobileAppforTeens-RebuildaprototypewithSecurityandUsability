  ...
  return (
    <View style={warningSignStyles.container}>
      ...
      <ScrollView style={warningSignStyles.descriptionContainer}>
        ...
        <Text style={{ fontFamily: 'JakartaSemiBold' }}>Emotional abuse </Text>or psychological abuse can be verbal or nonverbal. Emotional abuse may include verbal abuse, such as yelling, name-calling, blaming, and <Text style={{ fontWeight: 'bold' }}>gaslighting. </Text>{'\n'}Nonverbal abuse may consist of behaviors and tactics such as isolation, intimidation, and coercion. Emotional abuse is just as damaging as physical abuse.
        </Text>
      </ScrollView>
    </View>
  );
